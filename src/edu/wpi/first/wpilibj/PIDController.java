...
public class PIDController implements IUtility{
    ...
    /**
     * Adds support for a second output
     * @param Kp
     * @param Ki
     * @param Kd
     * @param source
     ...
     */
     public synchronized void disableSetZero() {
        m_pidOutput.pidWrite(0);  //TODO: DOWANT
        m_enabled = false;
    }
    /**
     * Stop running the PIDController, without setting the output to zero before stopping.
     */
    public synchronized void disable() {
        //m_pidOutput.pidWrite(0);  //TODO: DONOTWANT
        m_enabled = false;
    }
