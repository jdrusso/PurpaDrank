 ...
 */
public class Relay extends SensorBase implements IDeviceController, PIDOutput {
    /**
    ...
    public void setDirection(Direction direction) {
        ...
        if ((Math.abs(output) == output) && output > 0.05){
            this.set(Value.kForward);
        }
        else if ((Math.abs(output) != output) && output < -0.05){
