...
public class RobotDrive implements MotorSafety, IUtility {
    ...
    public void tankDrive(GenericHID leftStick, GenericHID rightStick) {
      ...
      public void tankDriveReverse(GenericHID leftStick, GenericHID rightStick) {
        if (leftStick == null || rightStick == null) {
            throw new NullPointerException("Null HID provided");
        }
     tankDrive(-leftStick.getY(), -rightStick.getY());
    ...
    public void arcadeDrive(GenericHID moveStick, final int moveAxis,
       ...
       public void arcadeDriveReverse(GenericHID moveStick, final int moveAxis,
        GenericHID rotateStick, final int rotateAxis,
        boolean squaredInputs) {
    double moveValue = moveStick.getRawAxis(moveAxis);
    double rotateValue = rotateStick.getRawAxis(rotateAxis);
    arcadeDriveReverse(moveValue, rotateValue, squaredInputs);
}
    public void arcadeDriveHalfSensitivity(GenericHID moveStick, final int moveAxis,
        GenericHID rotateStick, final int rotateAxis,
        boolean squaredInputs) {
    double moveValue = moveStick.getRawAxis(moveAxis);
    double rotateValue = rotateStick.getRawAxis(rotateAxis);
    arcadeDriveHalfSensitivity(moveValue, rotateValue, squaredInputs);
}
    ...
    public void arcadeDrive(GenericHID moveStick, final int moveAxis,
            GenericHID rotateStick, final int rotateAxis) {
        this.arcadeDrive(moveStick, moveAxis, rotateStick, rotateAxis, false);
    }
    public void arcadeDriveReverse(GenericHID moveStick, final int moveAxis,
            GenericHID rotateStick, final int rotateAxis) {
        this.arcadeDriveReverse(moveStick, moveAxis, rotateStick, rotateAxis, false);
    }
    ...
    /**
     * Adds functionality for a version of arcadeDrive that operates at half sensitivity.
     * @param moveValue
     *
     * @param rotateValue
     * @param squaredInputs
     */
public void arcadeDriveHalfSensitivity(double moveValue, double rotateValue, boolean squaredInputs) {
        // local variables to hold the computed PWM values for the motors
        double leftMotorSpeed;
        double rightMotorSpeed;
        moveValue = limit(moveValue);
        ...
        setLeftRightMotorOutputs(.5*leftMotorSpeed, .5*rightMotorSpeed);
    }
public void arcadeDriveReverse(double moveValue, double rotateValue, boolean squaredInputs) {
        // local variables to hold the computed PWM values for the motors
        double leftMotorSpeed;
        double rightMotorSpeed;
        moveValue = limit(moveValue);
